 // Recebe mensagens do iframe
    ...
    onValue(jogadoresRef, (snapshot) => {
        ...
        if (dados) {
            // Para cada jogador, cria um elemento na tela
            Object.keys(dados).forEach((id) => {
                ...
                div.classList.remove("WaitRespostas")
                div.classList.remove("CorretaRespostas")
                div.classList.remove("ErradaRespostas")
                RespotaCorreta = localStorage.getItem("RespostaCorreta");
                if (dados[id].perguntas[RespostasID] == -1)
                    div.classList.add("WaitRespostas")
                else if (dados[id].perguntas[RespostasID] == RespotaCorreta)
                ...
                div.textContent = jogador.nome; // mostra apenas o nome
